...
<div class="modal fade" id="editMoUModal" tabindex="-1" aria-labelledby="tambahMouModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="editMouForm" action="{{ route('mou.update', $mou->id_mou) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="edit_jenis_kerjasama" name="jenis_kerjasama" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="edit_file_mou" name="file_mou" accept=".pdf">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" onclick="$('#editMouModal').modal('hide')">Batal</button>
