    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                            ...
                            <tbody>
                                @foreach ($wisuda as $wsd)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/wissuda/' . $wsd->id . '/detail') }}"
                                                class="btn btn-info btn-sm"><i class="fas fa-info-circle"></i></a>
                                            <a href="{{ url('/wissuda/' . $wsd->id . '/edit') }}"
                                                class="btn btn-warning btn-sm"><i class="fas fa-pencil-alt"></i></a>
                                            <a href="{{ url('/wissuda/' . $wsd->id . '/delete') }}"
                                                class="btn btn-danger btn-sm"
                                                onclick="return confirm('Apakah yakin ingin menghapus {{ $wsd->mahasiswa->nama_mahasiswa }} ?')"><i
                ...
                <!-- /.card-body -->
                <div class="d-flex justify-content-start ml-3 mb-4">
