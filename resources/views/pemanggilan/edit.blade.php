...
@section('content')
    <div class="container">
        <ol class="breadcrumb bg-light p-2 rounded">
            <li class="breadcrumb-item"><a href="{{ url('/') }}" class="text-info"><i class="fas fa-home"></i> Home</a>
            </li>
            <li class="breadcrumb-item"><a href="{{ url('/data-pemanggilan') }}" class="text-info"><i class="fas fa-user"></i>
                    Data Pemanggilan</a></li>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama_ortu"
                                    value="{{ $pemanggilan->nama_ortu }}" required>
                            </div>
                            <div class="form-group">
                                <label>No Telepon</label>
                                <input type="text" class="form-control" name="no_telp_ortu"
                                    value="{{ $pemanggilan->no_telp_ortu }}" required>
                            </div>
                            <div class="form-group">
                                <label>Alamat</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="semester" required>
                                    ...
                                    @for ($i = 1; $i <= 8; $i++)
                                        <option value="{{ $i }}"
                                            {{ $pemanggilan->semester == $i ? 'selected' : '' }}>Semester
                                            {{ $i }}</option>
                                    @endfor
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" name="jurusan" required>
                                    ...
                                    <option value="JKB" {{ $pemanggilan->jurusan == 'JKB' ? 'selected' : '' }}>JKB
                                    </option>
                                    <option value="JRM & IP" {{ $pemanggilan->jurusan == 'JRM & IP' ? 'selected' : '' }}>
                                        JRM & IP</option>
                                    <option value="JREM" {{ $pemanggilan->jurusan == 'JREM' ? 'selected' : '' }}>JREM
                                    </option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="prodi" required>
                                    ...
                                    @foreach ($prodiOptions as $prodi)
                                        <option value="{{ $prodi }}"
                                            {{ $pemanggilan->prodi == $prodi ? 'selected' : '' }}>{{ $prodi }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
